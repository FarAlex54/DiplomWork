...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
                ...
                .requestMatchers("/authentication","/registration","/error","/resources/**","/static/**","/css/**","/js/**","/img/**", "/font/**","/product","/product/info/{id}", "/product/search","/person_account","/user").permitAll()
